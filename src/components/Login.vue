...
<div class="login">
  <div :class="['form', {'expand': isRegisterTabActive}]">
    ...
    <div v-show="isLoginTabActive" class="login-area page">
      ...
      <div id="signin" :class="{'available': canSignIn}">Sign in</div>
    </div>
...
export default {
  ...
  computed: {
    ...
    passwordsMatch: function() {
        return this.registerPassword === this.registerPassword2 && this.registerPassword.length > 0;
    },
    canSignIn: function() {
    ...
    canSignUp: function() {
        return this.checkRegisterEmail &&
            this.passwordsMatch;
    }
  },
  data() {
